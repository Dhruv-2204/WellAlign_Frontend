...
import { ProgressHubView } from './views/ProgressHubView.js';
...
const routes = [
  ...
  { path: '/progress', name: 'progress', component: ProgressHubView, meta: { requiresAuth: true } },
  { path: '/plan', redirect: '/progress', meta: { requiresAuth: true } },
